...
// Google Sheet ID - ခင်ဗျားရဲ့ Sheet ID ထည့်ပါ
...
app.get('/api/videos', async (req, res) => {
  try {
    ...
    for (let i = 1; i < lines.length; i++) {
      ...
      // Extract video ID from YouTube URL or use index
